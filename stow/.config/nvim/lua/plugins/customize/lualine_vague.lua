-- This is taken directly from https://github.com/nvim-lualine/lualine.nvim/blob/2a5bae925481f999263d6f5ed8361baef8df4f83/lua/lualine/themes/auto.lua
-- It basically allowed me to have access to the colors object that it created after applying the 'auto' theme, which is derived
-- from the colorscheme that's set globally in my nvim config.
